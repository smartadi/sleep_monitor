...
| "Diagnostic estimates from 50 random windows agreed with whole-night values to within 0.04" (§3.5, §4.2.1, §5.1) | **fails for 2/12**: resp S3N1 Δ = 0.061, S3N2 Δ = 0.080 | Holds for all 12 cardiac sessions (max 0.029). Recheck how "whole-night k" was defined; under the natural definition (median ratio over all epochs) the claim is false as stated. |
