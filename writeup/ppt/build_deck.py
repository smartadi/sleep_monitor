...
SLIDES = [
    ...
    *per_night("channel_evolution/%s_CH_CLE-CRE.png", "Sensor value — %s",
    ...
    (None, "Arousals hour by hour, all twelve nights",
     "Every night, every hour, both instruments: rows paired per night, night means right, cohort shape below.",
     "prof_metrics/arousal_hourly_matrix.png"),
